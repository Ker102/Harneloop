...
def package_unit(unit_root: Path, output: Path, profile: str = "thin", version: str | None = None) -> Path:
    ...
    with tarfile.open(output, "w:gz") as archive:
        ...
        info = tarfile.TarInfo(f"{package_root_name}/HARNELOOP_PACKAGE.json")
