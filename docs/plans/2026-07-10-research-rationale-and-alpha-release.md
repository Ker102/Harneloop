...
Explain why Harneloop treats the harness as the first task-specific optimization surface and publish the current implementation as the `v0.0.1` private alpha.
...
- Distinguish research support from the origin of Harneloop: the project came from practical agent-development experience, while the papers independently support its direction.
...
- Publish it as a GitHub prerelease titled `Harneloop v0.0.1 - Private Alpha`.
