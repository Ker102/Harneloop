...
**The EvoRig engine** owns lifecycle integrity: atomic records, immutable finished runs, protected framework state, validated evidence references, candidate promotion, snapshots, rollback, packaging, and exports.
