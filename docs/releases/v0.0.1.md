# EvoRig v0.0.1 - Private Alpha

The first private-alpha release of EvoRig: an agent-first framework for building and improving task-specific AI agent harnesses through evidence-backed trial and error.
...
- EvoRig records environment mappings; the operating agent must inspect and map the real tools, endpoints, commands, and artifact paths.
...
See the [README](https://github.com/Ker102/EvoRig#readme) for agent-first setup and the complete harness-unit lifecycle.
